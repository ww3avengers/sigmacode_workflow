  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='max-w-3xl max-h-[85vh] flex flex-col'>
        ...
        <Tabs
          value={editingWebhookId ? 'create' : undefined}
        ...
        >
          ...
          <TabsContent value='webhooks' className='space-y-4 flex-1 overflow-hidden flex flex-col'>
            {isLoading ? (
              ...
              <div className='overflow-y-auto h-[700px] pr-2 space-y-3'>
          ...
          <TabsContent value='create' className='space-y-4'>
                      ...
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => {
                          if (checked) {
                            ...
                            setNewWebhook({
                              ...newWebhook,
                              triggerFilter: newWebhook.triggerFilter.filter((t) => t !== trigger),
                            })
                          }
                        }}
                      />
            ...
            <DialogFooter className='mt-6'>
              {editingWebhookId && (
                <Button variant='outline' onClick={cancelEdit} disabled={isCreating}>
                  Cancel
                </Button>
              )}
              <Button
