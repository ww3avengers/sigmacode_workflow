...
import { DotPattern } from '@/app/(landing-2)/components/dot-pattern'
import { HeroBlock } from '@/app/(landing-2)/components/hero-block'
import { OrbitingCircles } from '@/app/(landing-2)/components/magicui/orbiting-circles'
